...
public class TopicBatch {
    private final Logger logger = LoggerFactory.getLogger(TopicBatch.class);
    ...
    public TopicBatch(ConsumerRecord<String, String> _leaderRecord, String _compressionTypeName) {
        this.leaderRecord = _leaderRecord;
        this.writeDir = Config.WriterServiceDir + "/" + leaderRecord.topic();
        this.compressionType = CompressionType.getCompressionType(_compressionTypeName);
    }
